...
Response.create!(respondent_id: 1, answer_id: 1, text: "1 thing")
Response.create!(respondent_id: 1, answer_id: 1, text: "another thing")
Response.create!(respondent_id: 1, answer_id: 1, text: "hello")
Response.create!(respondent_id: 1, answer_id: 2, text: "rallsdf")
Response.create!(respondent_id: 1, answer_id: 2, text: "wwwwwww")
Response.create!(respondent_id: 2, answer_id: 3, text: "world")
Response.create!(respondent_id: 2, answer_id: 3, text: "ddddddddd")
Response.create!(respondent_id: 2, answer_id: 4, text: "something else")
